        ...
        if (!isInstalled && typeof togglePopup === "function") {
            ...
            if (popup && popup.style.display !== 'flex') {
                ...
                if(pDev) {
                    ...
                    pDev.innerHTML = "Note <br>Behtareen experience aur offline use karne ke liye app install karein.<br><br><span style='color:#f29741; font-weight:bold;'></span>";
                }
            }
        }
    }, 2000);
...
if(waEl) {
    waEl.onclick = () => {
        window.open("https://wa.me/923346800959?text=Hi%20Wasi%20Developers,%20I%20have%20a%20query%20about%20the%20Calculator%20for%20my%20Business.", "_blank");
    };
}
...
const appInfoData = {
    ...
    devWA: "0334-6800959",
    version: "v2.0.31",
    installText: "Dar ul Haram Calculator",
    closeText: "Close"
};
